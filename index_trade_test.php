...
<div class="container">
  ...
  {
echo '  <table width = "100%"><tr><td width="20%"><a href="index.php?myAction=Lots"><img src="./images/pratt_construction.jpg"  /></a> </td><td width="80%"><h2><span style="color:red; font-size:1.5em">Testing</span> Pratt for Trades</h2></td></tr></table>  ';
  }
  ?>
    <!-- end .header --></div>
    <?
